...
### Do
  ...
  * Use this app layout for productive use cases that require high levels of user interaction and focus. For more help choosing the application layout that best supports your use case, follow the guidelines for [layout](/foundation/visual-foundation/layout/).
...
The breadcrumbs area is a dedicated section in the toolbar that displays [breadcrumbs](/components/breadcrumb-group/). It’s important that this area doesn’t go unused, in order to help promote an efficient use of space. 
