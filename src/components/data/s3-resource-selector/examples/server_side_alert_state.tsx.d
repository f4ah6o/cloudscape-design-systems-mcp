...
export default () => {
  ...
  return (
    <S3ResourceSelector
      ...
      alert={
        <Alert header="Object versions were not retrieved">
          {" "}
          You might not have permissions to retrieve object versions. Contact
          your account administrator. If no version ID is specified, the most
          recent version of the object is used.{" "}
        </Alert>
      }
    />
  );
